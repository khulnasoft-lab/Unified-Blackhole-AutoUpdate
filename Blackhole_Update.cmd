...
rem =====
rem For more information on KhulnaSoft-Lab and more KhulnaSoft-Lab scripts visit the following URL:
rem https://KhulnaSoft.github.io/
rem Or visit the following URL for the latest information on this KhulnaSoft-Lab script:
rem https://github.com/KhulnaSoft-Lab/Unified-Blackhole-AutoUpdate
rem =====
...
set CACHE=Unified-Blackhole-AutoUpdate
...
set GH=https://%GHD%/KhulnaSoft-Lab/Unified-Blackhole-AutoUpdate
set HOSTS=%SYSTEMROOT%\System32\drivers\etc\hosts
set CHOSTS=%CACHE%\hosts
set BASE=https://%GHD%/KhulnaSoft/blackhole/master
...
if not exist "%CUSTOM%" (
	(
		echo # Custom entries managed by KhulnaSoft-Lab's Unified Hosts AutoUpdate
	...
	for /f "tokens=1* delims=:" %%a in (
		...
		if !WRITE!==1 (
			...
			if /i "%%b"=="#### BEGIN UNIFIED HOSTS ####" (
				if %1==0 (
					echo %%b
					echo # Managed by KhulnaSoft-Lab's Unified Hosts AutoUpdate
					echo # https://github.com/KhulnaSoft-Lab/Unified-Blackhole-AutoUpdate
					if !HASH!==1 (
